...
import com.positivo.podcast.services.TokenService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = this.usuarioRepository.findByEmail(userEmail)
                    .orElse(null); // Tratar erro se usuário não for encontrado

            if (userDetails != null && tokenService.isTokenValid(jwt, (Usuario) userDetails)) {
